...
draft = false
weight = 20
aliases = ['/getting-started.html', '/documentation/getting-started.html']
+++
...
[What is Terraform / OpenTofu?](/docs/what-is-terranix/)
...
This example is adapted from the pure HCL example in [What is Terraform / OpenTofu?](/docs/what-is-terranix/):
