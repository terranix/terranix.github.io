+++
title = 'Getting started with flakes'
date = '2026-05-30'
draft = false
weight = 20
aliases = [
  '/getting-started-with-flakes.html',
  '/getting-startet-with-nix-flakes.html',
  '/documentation/getting-startet-with-nix-flakes.html',
  '/flakes.html',
  '/documentation/flakes.html',
]
+++
...
Extending [Getting started](/docs/getting-started/), this minimal flake defines your terranix resources in `config.nix`:
...
For more on the module system itself, see the [Modules](/docs/modules/) page.

As a next step, read [terranix and flake modules](/docs/getting-started/flake-modules/)
