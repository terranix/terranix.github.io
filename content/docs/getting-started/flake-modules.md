+++
title = 'terranix and flake modules'
date = '2026-05-30'
draft = false
weight = 40
aliases = ['/terranix-and-flake-modules.html']
+++
...
with flakes](/docs/getting-started/with-flakes/) page shows what this looks like.
...
See [Customizing the Terraform binary](/docs/getting-started/terraform-wrapper/) for how to use
